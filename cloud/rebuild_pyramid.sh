...
for l in 3 4 5 6 7; do nice .venv/bin/python cloud/make_levels.py $B $((l - 1)) $l 1 --threads 8; done
...
for l in 3 4 5 6 7; do nice -n 15 .venv/bin/python cloud/make_levels.py $B $((l - 1)) $l 1 --threads 8; done
